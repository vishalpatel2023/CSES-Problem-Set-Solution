...
void solve(){
    ll n;cin>>n;
    vector<ll> x(n); in(x,n); //take input

    map<ll,ll> mp;
    for(ll val: x) mp[val]++;

    //1 1 1 --> only take 1 elements or don't take any
    //total number of way--> 3 (frequency of 1) + 1 (don't take any)
